    ...
    <>
      ...
      <Grid.Row style={{ }}>
        ...
        <Grid textAlign='center' style={{  }} verticalAlign='middle'>
              <Grid.Column style={{ maxWidth: 450, color: '#006468 !important' }}>
                <Header as='h2' style={{ textAlign: 'center', color: '#006468 !important'}}>
                  Log In
                </Header>
        ...
        <Grid.Column width={4} style={{ textAlign: 'center', paddingTop: '20px'}}>
        <div>
